...
export class DockerExecutor extends CommandExecutor {
    ...
    constructor(shell = "/bin/sh", cwd: string = null) {
        super(cwd);
        this._shell = shell;
    }
